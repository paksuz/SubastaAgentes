 ...
 * @author ferta
 */
public class AgenteRacionalGUI extends JFrame {
    ...
    private AgenteRacional_v2 pujador;
    private int wallet;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    AgenteRacionalGUI frame = new AgenteRacionalGUI();
    ...
    public AgenteRacionalGUI(HashMap<Producto, String> productos, AgenteRacional_v2 pujador) {
        this();
